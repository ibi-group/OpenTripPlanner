 ...
 * {@link OsmBoardingLocationVertex} instances. In some cities, these nodes have a ref=* tag which gives the
 * corresponding GFTS stop ID for the stop. See
 * <a href="http://wiki.openstreetmap.org/wiki/Tag:highway%3Dbus_stop">http://wiki.openstreetmap.org/wiki/Tag:highway%3Dbus_stop</a>
 * <p>
