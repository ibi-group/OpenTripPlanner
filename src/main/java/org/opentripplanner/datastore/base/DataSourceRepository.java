 ...
 * local disk or is in the cloud. The interface makes it possible to implement alternative ways to
 * access data. In a cloud ecosystem you might find it easier to access the data directly from the
 * cloud storage, rather than first copy the data into your node local disk, and then copy the built
...
public interface DataSourceRepository {
  ...
  /**
   * Get a data source for the given uri and type.
   * <p>
   * The source may or may not {@link DataSource#exists()}.
   *
   * @param uri a unique URI to get the data source.
  ...
  /**
   * Get a composite data source (zip/directory) for the given uri and type.
   * <p>
   * The source may or may not {@link DataSource#exists()}.
   *
