...
public class MobilityProfileRouting {
  private static final Map<MobilityProfile, Float> TRAVEL_SPEED_MPH_BY_PROFILE = new EnumMap<>(Map.ofEntries(
  ...
  public static float computeTravelHours(double meters, MobilityProfile mobilityProfile) {
    return (float)(meters / 1000 / ONE_MILE_IN_KILOMETERS / TRAVEL_SPEED_MPH_BY_PROFILE.getOrDefault(mobilityProfile, TRAVEL_SPEED_MPH_BY_PROFILE.get(MobilityProfile.NONE)));
  }
}
